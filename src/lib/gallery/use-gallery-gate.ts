...
import { expectedBgDigest, expectedGalleryDigest, expectedStageDigest } from "@/lib/gallery/gate-key";
...
export const useGalleryBgGate = createSessionGate(GALLERY_BG_GATE_SESSION_KEY, expectedBgDigest);
